...
def check_timing_file(expected_rows):
    ...
    if len(timing_lines) != expected_rows:
        print(f"Test FAILED: {TIMING_FILE} should contain {expected_rows} timing rows.")
        sys.exit(1)
...
def run_compare_outputs(expected_timing_rows):
    ...
    check_timing_file(expected_timing_rows)
