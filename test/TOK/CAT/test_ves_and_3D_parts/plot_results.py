...
def main():
    parser = argparse.ArgumentParser(
        description="Plot intersections, vessel, and parts for the 3D vessel/parts test."
    )
    parser.add_argument(
        "--ref",
        action="store_true",
    ...
    parser.add_argument(
        ...
        dest="plot_3d",
        action="store_true",
        help="Plot vessel, parts, and intersections in Cartesian 3D.",
    )
    parser.add_argument(
        "--nphi_AS_to_3D",
        dest="nphi_AS_to_3D",
    ...
    if args.plot_3d:
        ...
        ax.set_title("TOK/CAT vessel and 3D part intersections 3D")
    else:
        ...
        if args.launch_pts:
            ...
            ax.legend()
        ax.set_title("TOK/CAT vessel and 3D part intersections")
